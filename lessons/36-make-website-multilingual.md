  ...
  settings: [
    {
      ...
      site: {
        name: 'BuyBox',
        description:
          'BuyBox is a sample Ecommerce website built with Next.js, Tailwind CSS, and MongoDB.',
...
-export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || 'BuyBox'
...
const shippingAddressDefaultValues =
  process.env.NODE_ENV === 'development'
    ? {
        fullName: 'Shipon',
        street: '1216,kandirpar, cumilla ',
        city: 'Cumilla',
        province: 'Police line ',
        phone: '01703059461',
        postalCode: '3623',
        country: 'BanglaDesh',
      }
